...
def main():
    ...
    def on_close():
        ...
        plt.subplot(131 )
        plt.hist(entry_timestamp_list,bins = 40)
        plt.xlabel('time point')
        plt.ylabel('frequency')
        plt.title('beacon entries')
        plt.text(50, 1.7, 'number of pellets: %0.0f '% arena.feed_counts,fontsize = 15)
        plt.subplot(132)
        plt.hist(entry_duration_list, bins = 20)
        plt.xlabel('time (s)')
        plt.ylabel('frequency')
        plt.title('beacon stays')
        plt.text(1.5, 0.9, 'Time in beacon: %0.0f '% arena.cumulative_in,fontsize = 15)
        plt.subplot(133)
        plt.hist(sham_entry_duration_list, bins = 20)
        plt.xlabel('time (s)')
        plt.ylabel('frequency')
        plt.title('SHAM beacon stays')
        plt.text(1.5, 1.8, 'Time in SHAM beacon: %0.0f '% arena.cumulative_in2,fontsize = 15)
